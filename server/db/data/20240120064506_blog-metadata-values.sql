CREATE TEMP TABLE IF NOT EXISTS VARIABLES (Name TEXT PRIMARY KEY, Value ANY);
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'blog-ideas'), (select id from tags where name = 'hidden'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'qmk-macros'), (select id from tags where name = 'QMK'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'testing-svelte'), (select id from tags where name = 'Svelte'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'testing-svelte'), (select id from tags where name = 'Vite'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'qmk-timers'), (select id from tags where name = 'QMK'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'blog-structure'), (select id from tags where name = 'Svelte'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'blog-structure'), (select id from tags where name = 'Vite'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'code-workflow'), (select id from tags where name = 'Personal'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'blog-explainer'), (select id from tags where name = 'Svelte'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'qmk-tapdances'), (select id from tags where name = 'QMK'));
		...
		INSERT OR IGNORE INTO tags(name)
		VALUES ("Signal Processing");
		
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'fft-noise'), (select id from tags where name = 'Signal Processing'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'fft-noise'), (select id from tags where name = 'WebAssembly'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'fft-noise'), (select id from tags where name = 'Sound'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'auto-db'), (select id from tags where name = 'AI Coding'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'blog-devlog'), (select id from tags where name = 'Rust'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'blog-devlog'), (select id from tags where name = 'Svelte'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'keyboard'), (select id from tags where name = 'QMK'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'keyboard'), (select id from tags where name = 'Projects'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'lofi-gen'), (select id from tags where name = 'Sound'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'lofi-gen'), (select id from tags where name = 'Webassembly'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'lofi-gen'), (select id from tags where name = 'Machine Learning'));
		...
		INSERT OR IGNORE INTO blogs_tags(blog_id, tag_id)
		VALUES ( (select id from blogs where slug = 'infinite-scroller'), (select id from tags where name = 'Svelte'));
