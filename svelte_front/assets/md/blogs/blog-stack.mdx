---
title: Blog Stack
coverImage: /blog/assets/images/blog-stack.webp
...
As this blog is a launch pad for my projects, each new feature will run on this backend until it's ready to be spun out into a seperate server. I am architecting the features and applications in such a way that splitting the apps out will be easy. Ease of architectural refactoring is a major reason why I want to try out the microfrontends pattern. Time will tell if it is good in practice.
