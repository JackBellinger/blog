...
updated: 2024-04-21T15:28:16.000Z
...
Once began conceptualizing this as a state machine, I built the rest of the state management code around that idea. I was able to encapsulate most of the state mutation into start_{state} and end_{state} functions. 
...
<Image src="../../images/tdm_state_machine_diagram.webp" />
